<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="table-label">
				<h4><strong>Ver Reporte X Cobrador<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>reporte_cobrador_fecha/imprimir_reporte" method="POST"  enctype="multipart/form-data">
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-2 col-sm-2 col-xs-2">
					   ...
					   <?php if ($cobrador): ?>
					   	...
					   	<input type="text" class="form-control" name="txt_cobrador" value="<?=$key->nombre?>" placeholder="" readonly="true">
					   	<?php endforeach ?>
					   <?php endif ?>
	...
	<? $fecha=date("Y-m-d")?>
					<div class="col-md-2 col-sm-2 col-xs-12">
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<input type="text" class="form-control" id="" name="" class="form-control" value="<?=$fecha_inicio?>" readonly="true" /> 			
						<?php endif ?>
	...
	<? $fecha=date("Y-m-d")?>
					<div class="col-md-2 col-sm-2 col-xs-12">
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<input type="text" class="form-control" id="" name="" class="form-control" value="<?=$fecha_final?>" readonly="true" /> 			
						<?php endif ?>
	...
	<? $fecha=date("Y-m-d")?>
					<div class="col-md-2 col-sm-2 col-xs-12">
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<input type="text" class="form-control" id="txt_total" name="txt_total" class="form-control" value="<?=$key->total?>" readonly="true" /> 			
							<?php endforeach ?>
						<?php endif ?>
