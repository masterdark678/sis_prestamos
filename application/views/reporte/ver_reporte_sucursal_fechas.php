<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="table-label">
				<h4><strong>Ver Reporte Sucursal<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>reporte_sucursal_fechas/imprimir_reporte" method="POST"  enctype="multipart/form-data">
	...
	<p></p>
					<div class="col-md-2 col-sm-2 col-xs-12">
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12">
						...
						<input type="hidden" name="txt_id_sucursal" value="<?=$key->id_sucursal?>">
						<input type="text" class="form-control" id="" name="" class="form-control" value="<?=$key->descripcion?>" readonly="true" /> 					
							<?php endforeach ?>
						<?php endif ?>
