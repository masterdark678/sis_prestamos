<div class="right_col" role="main" style="height:auto">
			...
			<div class="table-label">
				<h4><strong>Reporte X Zona<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>reporte_zona_fechas/calculo_zona" method="POST"  enctype="multipart/form-data">
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-2 col-sm-2 col-xs-2">
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12">
							<select class="form-control" name="id_zona" id="id_zona" data-show-subtext="true" data-live-search="true"  required="required">
										<option value="">Seleccione Zona</option>
										 <?php
										 if ($zona) {
										 foreach ($zona as $i) {
								             echo '<option value="'. $i->id .'">'.$i->zona.'</option>';
								            }
										 }else{
										 }
								        ?>
