<div class="right_col" role="main" style="height:1040px;">
			...
			<div class="table-label">
				<h4><strong>Ver Reporte Todos<strong></h4>
				</div>
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>reporte_todos_cobradores_fechas/imprimir_reporte" method="POST"  enctype="multipart/form-data">
