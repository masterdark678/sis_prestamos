					...
					<div class="col-md-12 col-sm-12 col-xs-12" id="botones" style="display: block">
					  <hr>
							<div class="col-md-12 col-sm-12 col-xs-12" align="center">
							 ...
							 <a href="<?=$this->config->base_url()?>prestamo/grilla_todos_estado_prestamo_aprobado" class="btn btn-lg btn-warning" title=""><i class="fa  fa-exclamation-triangle"></i>&nbsp;Volver</a>
							</div>
									</form>
