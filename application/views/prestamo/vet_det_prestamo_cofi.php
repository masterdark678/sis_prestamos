...
<div class="col-md-12 col-sm-12 col-xs-12">
	...
	<thead>
		<tr>
			<th class="info"><h5><strong>Tipo</strong></h5></th>
			<th class="info"><h5><strong># Cuotas</strong></h5></th>
			<th class="info"><h5><strong>Monto</strong></h5></th>
			<th class="info"><h5><strong>Fecha Pago</strong></h5></th>
			<th class="info"><h5><strong>Observacion</strong></h5></th>
		</tr>
	</thead>
	<tbody>
	...
	<thead>
		<tr>
			<th class="info"><h5><strong>Fecha de atraso</strong></h5></th>
			<th class="info"><h5><strong>Prox dia Cobro</strong></h5></th>
			<th class="info"><h5><strong>Observaciones</strong></h5></th>
					...
					<div class="col-md-12 col-sm-12 col-xs-12" id="botones" style="display: block">
					  <hr>
							<div class="col-md-12 col-sm-12 col-xs-12" align="center">
							 ...
							 <a href="<?=$this->config->base_url()?>prestamo/grilla_cobrador_estado_prestamo_finalizado" class="btn btn-lg btn-warning" title=""><i class="fa fa-print"></i>&nbsp;Volver</a>
							</div>
									</form>
