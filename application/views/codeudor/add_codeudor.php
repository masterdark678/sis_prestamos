	...
	<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-2 col-sm-2 col-xs-2">
					...
					<?php foreach ($cliente as $key): ?>
						<input type="hidden" name="id_cliente" value="<?=$key->id_cliente?>">
						<input type="text" class="form-control" name="txt_cliente" id="txt_cliente" value="<?=$key->nombre_cliente?>" placeholder="" readonly="true">
						<?php endforeach ?>
						</div>
					</div>
				<div class="col-md-12 col-sm-12 col-xs-12">
