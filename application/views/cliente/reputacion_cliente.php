<div class="right_col" role="main" style="height:auto">
			...
			<div class="table-label">
				<h4><strong>Cambiar Reputacion Cliente<strong></h4>
				</div>
			<div class="form-container table-container">
				<?php if ($cliente): ?>
						<?php foreach ($cliente as $key): ?>
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>cliente/actualizar_reputacion" method="POST"  enctype="multipart/form-data">
...
<!-- **************************************************************************** -->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-3 col-sm-3 col-xs-3">
						<h5><label>Reputacion Actual:</label></h5></P>
						</div>
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<input type="text" name="txt_cobrador" class="form-control" value="<?=$key->reputacion_cliente?>" placeholder="" readonly="true">
						</div>
					</div>
						<?php endforeach ?>
				<?php endif ?>
<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
						<h5><label>Nueva Reputacion:</label></h5></P>
						</div>
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<select class="selectpicker form-control" name="id_reputacion" id="id_reputacion" data-show-subtext="true" data-live-search="true">
										<option value="">Seleccione Reputacion</option>
										 <?php
										 if ($reputacion) {
										 foreach ($reputacion as $i) {
