<div class="right_col" role="main" style="height:auto">
			...
			<div class="form-container table-container">
				...
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>cliente/actualizar_cobrador" method="POST"  enctype="multipart/form-data">
...
<!-- **************************************************************************** -->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-3 col-sm-3 col-xs-3">
						<h5><label>Cobrador Actual:</label></h5></P>
						</div>
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<input type="text" name="txt_zona" class="form-control" value="<?=$key->nombre_cobrador?>" placeholder="" readonly="true">
						</div>
					</div>
						<?php endforeach ?>
				<?php endif ?>
<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
						<h5><label>Nuevo Cobrador:</label></h5></P>
						</div>
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<select class="selectpicker form-control" name="id_cobrador" id="id_cobrador" data-show-subtext="true" data-live-search="true">
