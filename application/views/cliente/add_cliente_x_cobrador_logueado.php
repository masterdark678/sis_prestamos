...
<input type="hidden" name="txt_id_cobrador" value="<?=$id_cobrador?>">
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="col-md-2 col-sm-2 col-xs-2">
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12">
							<select class="form-control" name="id_documentacion" id="id_documentacion" data-show-subtext="true" data-live-search="true" required="true">
...
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<input type="text" name="txt_referido_1" class="form-control" value="" placeholder="Ingrese una persona de referencia">
						</div>
					</div>
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-2 col-sm-2 col-xs-2">
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<input type="text" name="txt_referido_2" class="form-control" value="" placeholder="Ingrese una persona de referencia">
						</div>
					</div>
<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
