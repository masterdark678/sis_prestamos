<div class="right_col" role="main" style="height:auto">
			...
			<div class="table-label">
				<h4><strong>Cambiar Cobrador Cliente<strong></h4>
				</div>
			<div class="form-container table-container">
				<?php if ($cliente): ?>
						<?php foreach ($cliente as $key): ?>
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>cliente/actualizar_documentacion" method="POST"  enctype="multipart/form-data">
...
<!-- **************************************************************************** -->
	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-3 col-sm-3 col-xs-3">
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<input type="text" class="form-control" name="txt_docuentacion" value="<?=$key->documentacion_cliente?>" placeholder="" readonly="true">
						</div>
					</div>
						<?php endforeach ?>
				<?php endif ?>
<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="col-md-4 col-sm-4 col-xs-4">
						<h5><label>Nuevo estado de Documentacion:</label></h5></P>
						</div>
					   <div class="col-md-12 col-sm-12 col-xs-12">
						<select class="selectpicker form-control" name="id_documentacion" id="id_documentacion" data-show-subtext="true" data-live-search="true">
										<option value="">Seleccione Estado documentacion</option>
										 <?php
										 if ($documentacion) {
