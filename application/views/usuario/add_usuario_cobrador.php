<div class="right_col" role="main" style="height:auto">
			...
			<div class="form-container table-container">
				<form class="form-horizontal" role="form" action="<?php echo $this->config->base_url();?>usuario/guardar_usuario_cobrador" method="POST"  enctype="multipart/form-data">
	<!--*****************************************************************************-->
	<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<?php endforeach ?>
					   ...
					   <div class="col-md-12 col-sm-12 col-xs-12">
					   <input type="hidden"  name="id_nivel" value="3">
						<input type="text" class="form-control" name="txt_nivel" value="Cobrador"readonly="true">
						</div>
					</div>
				<div class="col-md-12 col-sm-12 col-xs-12">
					<p></p>
