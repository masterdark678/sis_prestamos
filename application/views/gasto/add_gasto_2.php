<div class="right_col" role="main" style="height:auto">
			...
			<div class="form-container table-container">
				...
				<div class="form-group">
					<p></p>
					<?php if ($cobrador): ?>
						<input type="hidden" name="txt_id_cobrador" value="<?=$cobrador?>">
						<?php else: ?>
						<input type="hidden" name="txt_id_cobrador" value="0">
					<?php endif ?>
					<div class="col-md-1 col-sm-1 col-xs-12">
					  ...
					  <div class="col-md-12 col-sm-12 col-xs-12">
						<input type="date" class="form-control" name="txt_fecha" value="" placeholder=" Ingrese DNI" required="true">
						</div>
